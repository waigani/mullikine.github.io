...
To do this you select the part of the code you would like to match and then click the _generate_ button.
The next step is refine that query into something that captures the logic of what you want a tenet to match.
